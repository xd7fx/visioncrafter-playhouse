...
import { BarChart3, TrendingUp, Type, Image, Lightbulb, Zap, FileText, ArrowRight, Youtube, Music2, Lock } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="flex flex-col items-center justify-center text-center px-6 pt-24 pb-20 md:pt-36 md:pb-28 relative overflow-hidden">
        ...
        >
          Analyze channels, discover trends, generate titles, thumbnails and scripts — all in one place.
        </motion.p>
        <motion.div
      ...
      <section id="features" className="px-6 md:px-12 pb-28">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-center text-muted-foreground mb-14 max-w-lg mx-auto">
            Each agent is purpose-built for a specific task in your content workflow.
          </p>
            ...
            {comingSoonAgents.map((agent, i) => {
              ...
              return (
                <motion.div
                  ...
                  whileInView={{ opacity: 1, y: 0 }}
                  viewport={{ once: true }}
                  transition={{ delay: (youtubeAgents.length + i) * 0.08 }}
                >
                  <div className="w-12 h-12 rounded-xl gradient-bg flex items-center justify-center mb-4">
                    <Icon size={22} className="text-primary-foreground" />
                  </div>
